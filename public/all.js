...
var pages = exports.pages = new _firebase2.default('https://react-wikipedia.firebaseio.com/pages');

},{"firebase":31}],208:[function(require,module,exports){
'use strict';
...
var routes = _react2.default.createElement(
  ...
  _react2.default.createElement(_reactRouter.Route, { path: 'page/:id', component: _App2.default })
);

_reactDom2.default.render(_react2.default.createElement(_reactRouter2.default, {
  children: routes,
  history: (0, _createHashHistory2.default)({ queryKey: false }) }), document.getElementById('app'));

},{"./components/App.js":209,"history/lib/createHashHistory":38,"react":204,"react-dom":51,"react-router":71}],209:[function(require,module,exports){
'use strict';
...
},{"./Login":210,"./PageList":211,"react":204}],210:[function(require,module,exports){
'use strict';
...
var Login = function (_React$Component) {
  ...
  function Login() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(Login)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.signin = function (evt) {
      return _this.sign('in', evt);
    }, _this.signup = function (evt) {
      return _this.sign('up', evt);
    }, _this.sign = function (name, evt) {
      var username = _reactDom2.default.findDOMNode(_this.refs.username).value;
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'p',
          null,
          _react2.default.createElement('input', { type: 'text', className: 'u-full-width', placeholder: 'Username', ref: 'username' })
        ),
        _react2.default.createElement(
          'p',
          null,
          _react2.default.createElement('input', { type: 'password', className: 'u-full-width', placeholder: 'Password', ref: 'password' })
        ),
        _react2.default.createElement(
          'p',
          null,
...
},{"../api":207,"react":204,"react-dom":51}],211:[function(require,module,exports){
'use strict';
...
var PageList = function (_React$Component) {
  ...
  function PageList() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(PageList)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
      loaded: false,
      pages: {},
      newPageTitle: ''
...
},{"../api":207,"react":204,"react-router":71}]},{},[208]);
